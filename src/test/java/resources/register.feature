...
#      | dcmu4@gmail.com | Mr    | Carolina  | Machado  | 123456   | 8    | 9      | 1990  | y          | y      | Huge    | calle 2 | calle 100 | Bogota | 3     | 11000 | 21      | none          | 3002114915 | 13300776732 | hugeDir     |
  ...
  Scenario Outline: Unsuccessful register
    ...
    #And I should see a notification error
    And I click on the Register button
    Then I should see an error notification
    Examples:
      | email           | title | firstName | lastName | password | days | months | years | newsletter | offers | company | address | address2  | city   | state | zip   | country | additionalInfo| homePhone  | mobilePhone | addressAlias |
      | dcmu4@gmail.com | Mr    | Carolina  | Machado  | 123456   | 8    | 9      | 1990  | y          | y      | Huge    | calle 2 | calle 100 | Bogota | 3     | 1100  | blank   | none          | 3002114915 | 13300776732 | hugeDir     |
